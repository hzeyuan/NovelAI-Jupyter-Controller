...
def show(cmd_):
    ...
    file1 = widgets.HTML(
        value="下载Stable Diffusion v1.5",
    )
    
    file1_download_buttom = widgets.Button(
        description='点击下载',
